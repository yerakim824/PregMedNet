...
def ADJ_ODDS_ALL():
    file_path_adj_or = Path(__file__).parents[0] / '2024_reference_tables/adj_or_all_nov2024.csv'
    adj_or_all = pd.read_csv(file_path_adj_or).drop(columns=['Unnamed: 0'],axis=1)
    return adj_or_all
